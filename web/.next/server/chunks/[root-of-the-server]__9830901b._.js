module.exports = [
"[project]/.next-internal/server/app/api/autocomplete/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/autocomplete/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const mockResults = productsArray.filter((item)=>{
        ...
        const nameMatch = item.name ? item.name.toLowerCase().includes(lowerCaseQuery) : false;
        // Check if item.partNumber exists and includes the query
        const partNumberMatch = item.partNumber ? item.partNumber.toLowerCase().includes(lowerCaseQuery) : false;
        // Return true if either name or partNumber matches
        return nameMatch || partNumberMatch;
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(mockResults);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__9830901b._.js.map