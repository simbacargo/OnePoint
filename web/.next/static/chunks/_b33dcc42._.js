...
const Card = (param)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-4 bg-white rounded-xl ".concat(className),
        children: children
    }, void 0, false, {
 ...
 */ const fetchProductsApi = async ()=>{
    try {
        console.log("[API CALL] Attempting to fetch products from: ".concat(DJANGO_API_BASE_URL)); // Enhanced logging
        const response = await fetch(DJANGO_API_BASE_URL);
        if (!response.ok) {
            // Log full error details for debugging
            const errorText = await response.text();
            console.error("[API ERROR] Fetch failed with status: ".concat(response.status), {
                details: errorText.substring(0, 200)
            });
            throw new Error("HTTP error! status: ".concat(response.status, ". Check Network/Console for CORS or server errors."));
        }
 ...
 */ const addProductApi = async (newProduct)=>{
    try {
        ...
        if (!response.ok) {
            throw new Error("HTTP error! status: ".concat(response.status, ". Details: ").concat(await response.text()));
        }
 ...
 */ const updateProductApi = async (productId, updatedData)=>{
    const url = "".concat(DJANGO_API_BASE_URL).concat(productId, "/");
    try {
        ...
        console.error("Error updating product ".concat(productId, " via API:"), error);
        throw error;
    }
};
/**
 ...
 */ const deleteProductApi = async (productId)=>{
    ...
    try {
        ...
        console.error("Error deleting product ".concat(productId, " via API:"), error);
        throw error;
    }
};
function ProductsPage() {
    ...
    const [totalNumberOfProducts, setTotalNumberOfProducts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const loadProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductsPage.useCallback[loadProducts]": async ()=>{
            setLoading(true);
    ...
    }["ProductsPage.useCallback[loadProducts]"], []);
    ...
    const displayedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductsPage.useMemo[displayedProducts]": ()=>{
            let list = products.filter({
                "ProductsPage.useMemo[displayedProducts].list": (p)=>{
                    var _p_name, _p_part_number, _p_brand;
                    return ((_p_name = p.name) === null || _p_name === void 0 ? void 0 : _p_name.toLowerCase().includes(searchQuery.toLowerCase())) || ((_p_part_number = p.part_number) === null || _p_part_number === void 0 ? void 0 : _p_part_number.toLowerCase().includes(searchQuery.toLowerCase())) || ((_p_brand = p.brand) === null || _p_brand === void 0 ? void 0 : _p_brand.toLowerCase().includes(searchQuery.toLowerCase()));
                }
            }["ProductsPage.useMemo[displayedProducts].list"]);
            list.sort({
                "ProductsPage.useMemo[displayedProducts]": (a, b)=>{
    ...
    const handleNavigate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductsPage.useCallback[handleNavigate]": function(view) {
            let product = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
            setSelectedProduct(product);
            setCurrentView(view);
        }
    }["ProductsPage.useCallback[handleNavigate]"], []);
    const handleAddProduct = async ()=>{
        const newProductData = {
            name: "New Unnamed Product",
            description: "Default description",
            brand: "Unbranded",
            part_number: "PN-".concat(Date.now() % 10000),
            vehicles: 'N/A',
            quantity: '10',
            price: '0.00',
            amount: '0.00',
    ...
    const handleDeleteProduct = async (productId, productName)=>{
        if (!window.confirm("Are you sure you want to delete ".concat(productName, " (ID: ").concat(productId, ")? This action is permanent."))) {
            return;
        }
        try {
    ...
    _s1(UpdateProductView, "AVXHxnXdS0M3vbPxhZX4lXWKRJM=");
    // --- VIEW 3: SELL PRODUCT FORM ---
    const SellProductView = (param)=>{
        let { product, onSaleComplete, onCancel } = param;
        _s2();
        const [quantitySold, setQuantitySold] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
        ...
        const handleSellSubmit = async (e)=>{
            ...
            if (unitsToSell <= 0 || unitsToSell > currentQuantity) {
                console.warn("Invalid quantity. Available stock: ".concat(currentQuantity));
                return;
            }
            setIsSelling(true);
            try {
    ...
    _s2(SellProductView, "0mKwEi9Mfr0ToyM7RWuNaQuy89k=");
        ...
        const SortableHeader = (param)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        children,
                        sortKey && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SortIcon, {}, void 0, false, {
                            fileName: "[project]/src/app/Products/page.js",
                            lineNumber: 519,
                            columnNumber: 37
                        }, this)
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        children: columns.map((col)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SortableHeader, {
                                                sortKey: col.key,
                                                currentSort: sort,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: loading ? [
                                        ...Array(PAGE_SIZE)
                                            ...
                                            lineNumber: 601,
                                            columnNumber: 73
                                        }, this)) : displayedProducts.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        lineNumber: 603,
                                        columnNumber: 37
                                    }, this) : displayedProducts.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "group transition duration-200 \n                                                ".concat(product.quantity < 5 ? 'bg-red-50/50' : product.id % 2 === 0 ? 'bg-gray-50' : 'bg-white', "\n                                                hover:bg-blue-50/70\n                                            "),
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold \n                                                    ".concat(product.quantity < 50 && product.quantity > 0 ? 'bg-yellow-100 text-yellow-700' : product.quantity > 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700', "\n                                                "),
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-6 py-4 whitespace-nowrap text-sm font-medium",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "inline-flex px-2 py-0.5 text-xs font-semibold rounded-full \n                                                    ".concat(product.status === 'In Stock' ? 'bg-green-100 text-green-800' : product.status === 'Low Stock' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'),
    ...
    if (loading) {
        ...
        switch(currentView){
            case 'edit':
                title = "Editing: ".concat((selectedProduct === null || selectedProduct === void 0 ? void 0 : selectedProduct.name) || 'Product');
                content = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UpdateProductView, {
                ...
                break;
            case 'sell':
                title = "Record Sale: ".concat((selectedProduct === null || selectedProduct === void 0 ? void 0 : selectedProduct.name) || 'Product');
                content = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SellProductView, {
                    product: selectedProduct,
            ...
            default:
                ...
                content = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductList, {}, void 0, false, {
                    fileName: "[project]/src/app/Products/page.js",
                    lineNumber: 726,
                    columnNumber: 27
                }, this);
...
_s(ProductsPage, "GNSQReGH3Rb/yrZt5uUNKFyelYQ=");
_c1 = ProductsPage;
var _c, _c1;
...
//# sourceMappingURL=_b33dcc42._.js.map